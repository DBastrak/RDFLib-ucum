...
class UnitTablesFactory:
    ...
    def unitsCount(self):
        return len(self.unitCodes_.keys())
    ...
    def getUnitByString(self, uString):
        retAry = None
        if uString:
    ...
    def getUnitsByDimension(self, uDim):
        ...
        unitsArray = self.unitDimnesions_[uDim]
